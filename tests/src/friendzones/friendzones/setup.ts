...
import { FriendzonesClient } from "../../../../ui/src/friendzones/friendzones/friendzones-client.js";
import { FriendzonesStore } from "../../../../ui/src/friendzones/friendzones/friendzones-store.js";
...
async function addPlayer(scenario: Scenario) {
  ...
  const store = new FriendzonesStore(
    new FriendzonesClient(player.appWs as any, "friendzones"),
  );
  return {
    store,
    player,
